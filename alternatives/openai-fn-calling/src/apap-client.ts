 ...
 *
 * Mirrors the same operations the MCP handler exposes, so the function-calling
 * comparison is apples-to-apples. Intentionally avoids retries, caching, or
 * other smarts: the goal is to surface the raw call shape, not hide it.
 */
